...
- Grounded Gemini explanation pathway with deterministic refusal and post-generation validation
- Simulated handoff delivery, retry/idempotency, compact audit, status, reviewer acknowledgement, and authored response fixtures
...
- Durable, governed audit storage
- Privacy, security, clinical, and regulatory review
- Real clinical-system integration and validated messaging
- Patient acknowledgement and genuine resolution semantics
- Deployment and operational monitoring

None of the Later items should be inferred from the prototype UI.