...
### Evidence Inbox
![ProductTrace Evidence Inbox](assets/01-evidence-inbox.jpg)

Raw customer and product signals are captured with source, date, tags, and analysis status before synthesis.

### AI Analysis
![ProductTrace AI Analysis](assets/02-ai-analysis.jpg)
...
### Opportunity Board
![ProductTrace Opportunity Board](assets/03-opportunity-board.jpg)
...
### Discovery Criteria
![ProductTrace Discovery Criteria](assets/04-discovery-sections.jpg)
...
### Experiment Design
![ProductTrace Experiment Design](assets/05-experiment-design.jpg)

The approved experiment captures hypothesis, primary metric, guardrails, decision threshold, design, and linked evidence.

### Instrumentation Plan
![ProductTrace Instrumentation Plan](assets/06-instrumentation-plan.jpg)
...
### Eval Center
![ProductTrace Eval Center](assets/07-eval-center.jpg)
...
### Launch Gate
![ProductTrace Launch Gate](assets/08-launch-gate.jpg)
...
### Market Opportunity
![ProductTrace Market Opportunity](assets/11-market-opportunity.jpg)
...
### Discovery Readiness
![ProductTrace Discovery Readiness](assets/12-discovery-readiness.jpg)
...
![ProductTrace More Discovery Needed](assets/13-more-discovery-needed.jpg)
...
![ProductTrace Falsification Checks](assets/14-falsification-checks.jpg)
...
![ProductTrace Research Finding Capture](assets/15-research-finding-entry.jpg)
